package org.virtue.deobfuscation.indentifiers.node;
...
public class DequeIdentifier extends AbstractClassIdentifier {
    ...
    public ClassElement identify() {
        ClassElement node = Injector.get(NodeIdentifier.class).identified();
    ...
    public class Head extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            final ClassElement nodeElement = Injector.get(NodeIdentifier.class).identified();
    ...
    public class Current extends AbstractFieldIdentifier {
        ...
        @Override
        public FieldElement identify() {
            ClassElement identified= Injector.get(NodeIdentifier.class).identified();
