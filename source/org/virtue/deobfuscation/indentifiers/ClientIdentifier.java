...
public class ClientIdentifier extends AbstractClassIdentifier {
    ...
    public class Widgets extends AbstractFieldIdentifier {
        ...
        @Override
        public FieldElement identify() {
            ClassElement widget = Injector.get(WidgetIdentifier.class).identified();
    ...
    public class CollisionMap extends AbstractFieldIdentifier {
        ...
        @Override
        public FieldElement identify() {
            ClassElement collisionMap = Injector.get(CollisionMapIdentifier.class).identified();
    ...
    public class WidgetNodeBag extends AbstractFieldIdentifier {
        @Override
        public FieldElement identify() {
            final ClassElement widgetNode = Injector.get(WidgetNodeIdentifier.class).identified();
            final ClassElement bag = Injector.get(BagIdentifier.class).identified();
            final Value<FieldElement> value = new Value<>();
    ...
    public class ItemDefinitionCache extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            ...
            ClassElement itemDef = Injector.get(ItemDefinitionIdentifier.class).identified();
            ClassElement cache = Injector.get(CacheIdentifier.class).identified();
    ...
    public class ObjectDefinitionCache extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            MethodQuery methodQuery = new MethodQuery();
            ClassElement objectDef = Injector.get(ObjectDefinitionIdentifier.class).identified();
            ClassElement cache = Injector.get(CacheIdentifier.class).identified();
    ...
    public class NpcDefinitionCache extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            MethodQuery methodQuery = new MethodQuery();
            ClassElement npcDef = Injector.get(NpcDefinitionIdentifier.class).identified();
            ClassElement cache = Injector.get(CacheIdentifier.class).identified();
