...
public class ClientIdentifier extends AbstractClassIdentifier {
    ...
    public class LootDeque extends AbstractFieldIdentifier {
        @Override
        public FieldElement identify() {
            ClassElement loot = VirtueTransformer.getInstance().getInjector().get(LootIdentifier.class).identified();
            ClassElement deque = VirtueTransformer.getInstance().getInjector().get(DequeIdentifier.class).identified();
    ...
    public class Widgets extends AbstractFieldIdentifier {
        ...
        @Override
        public FieldElement identify() {
            ClassElement widget = VirtueTransformer.getInstance().getInjector().get(WidgetIdentifier.class).identified();
    ...
    public class CollisionMap extends AbstractFieldIdentifier {
        ...
        @Override
        public FieldElement identify() {
            ClassElement collisionMap = VirtueTransformer.getInstance().getInjector().get(CollisionMapIdentifier.class).identified();
    ...
    public class WidgetNodeBag extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            ...
            final ClassElement bag = VirtueTransformer.getInstance().getInjector().get(BagIdentifier.class).identified();
            final Value<FieldElement> value = new Value<>();
    ...
    public class ItemDefinitionCache extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            ...
            ClassElement itemDef = VirtueTransformer.getInstance().getInjector().get(ItemDefinitionIdentifier.class).identified();
            ClassElement cache = VirtueTransformer.getInstance().getInjector().get(CacheIdentifier.class).identified();
    ...
    public class ObjectDefinitionCache extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            MethodQuery methodQuery = new MethodQuery();
            ClassElement objectDef = VirtueTransformer.getInstance().getInjector().get(ObjectDefinitionIdentifier.class).identified();
            ClassElement cache = VirtueTransformer.getInstance().getInjector().get(CacheIdentifier.class).identified();
    ...
    public class NpcDefinitionCache extends AbstractFieldIdentifier {
        ...
        public FieldElement identify() {
            MethodQuery methodQuery = new MethodQuery();
            ClassElement npcDef = VirtueTransformer.getInstance().getInjector().get(NpcDefinitionIdentifier.class).identified();
            ClassElement cache = VirtueTransformer.getInstance().getInjector().get(CacheIdentifier.class).identified();
