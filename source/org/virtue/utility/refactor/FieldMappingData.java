...
public class FieldMappingData extends Identifiable {
	...
	public FieldMappingData(MappingData name, String desc, boolean isStatic) {
		this("", name, desc, isStatic);
	}
	
	public FieldMappingData(String fieldOwner, MappingData name, String desc, boolean isStatic) {
